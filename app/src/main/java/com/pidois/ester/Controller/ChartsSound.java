...
public class ChartsSound extends ChartUtils {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_charts_sound);

        floatingActionButton = findViewById(R.id.chart_sound_floatingbtn);

        barChart = findViewById(R.id.sound_chart);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    long amount = Long.valueOf(rightAnswers);
    ...
    protected void saveToGallery() {
        saveToGallery(barChart, "Sound Chart");
    }
}
